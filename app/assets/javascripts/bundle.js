...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(TodoReact, null), document.getElementById('root'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	React = __webpack_require__(2);
	ReactDOM = __webpack_require__(159);
	TodoDetailView = __webpack_require__(163);
	...
	var TodoListItem = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { className: 'toggleDone', onClick: this.handleDone },
	        symbol
	      )
	    );
	  }
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'label',
	        { htmlFor: 'title' },
	        React.createElement('input', { id: 'title', type: 'text', value: this.state.title, onChange: this.updateTitle })
	      ),
	      React.createElement('br', null),
	      React.createElement(
	        'label',
	        { htmlFor: 'body' },
	        React.createElement('input', { id: 'body', type: 'text', value: this.state.body, onChange: this.updateBody })
	      ),
	      React.createElement('br', null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoDetailView = React.createClass({
	  ...
	  render: function () {
	    var renderedContent = React.createElement('div', null);
	    ...
	    if (this.props.displayed) {
	      renderedContent = React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { className: 'delete', onClick: this.props.handleDestroy },
	          'Delete'
	        )
	      );
	    }
